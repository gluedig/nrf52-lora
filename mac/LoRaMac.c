...
static void OnMacStateCheckTimerEvent( void * ctx)
{
...
static void OnTxDelayedTimerEvent( void * ctx)
{
    LoRaMacHeader_t macHdr;
    LoRaMacFrameCtrl_t fCtrl;
...
static void OnRxWindow1TimerEvent( void * ctx)
{
...
static void OnRxWindow2TimerEvent( void * ctx )
{
...
static void OnAckTimeoutTimerEvent( void * ctx)
{
    TimerStop( &AckTimeoutTimer );
...
LoRaMacStatus_t LoRaMacInitialization( LoRaMacPrimitives_t *primitives, LoRaMacCallback_t *callbacks )
{
    ...
    // Initialize timers
    TIMER_INIT( MacStateCheckTimer, OnMacStateCheckTimerEvent);
    TimerSetValue( &MacStateCheckTimer, MAC_STATE_CHECK_TIMEOUT );

    TIMER_INIT( TxDelayedTimer, OnTxDelayedTimerEvent );
    TIMER_INIT( RxWindowTimer1, OnRxWindow1TimerEvent );
    TIMER_INIT( RxWindowTimer2, OnRxWindow2TimerEvent );
    TIMER_INIT( AckTimeoutTimer, OnAckTimeoutTimerEvent );
